...
The damping simulation has been done with euler kinematics and dynamic equations, and the simulation is being redone using quaternion kinematics and dynamics.
